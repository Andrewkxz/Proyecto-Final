...
public class Lote extends Inmueble {
    ...
    public boolean isTieneServiciosPublicos() { return tieneServiciosPublicos; }
    public void setTieneServiciosPublicos(boolean tieneServiciosPublicos) { this.tieneServiciosPublicos = tieneServiciosPublicos; }
